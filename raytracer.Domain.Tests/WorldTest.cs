...
public class WorldTest
{
    ...
    public void testIfClosestIntersectionIsReturnedOneSphere()
    {
        ...
        Intersection intersection = world.getClosestIntersection(line);
    ...
    public void getBrightnessWithSingleSphere()
    {
        ...
        Assert.Equal(1, world.calcBrightness(intersection));
    }
    ...
    public void getBrightnessWithOnShadowSideShouldReturnZero()
    {
        ...
        Assert.Equal(0, world.calcBrightness(intersection));
    }
